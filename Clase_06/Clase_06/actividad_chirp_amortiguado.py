...
def main():
    ...
    alpha = 0.2     # Amortiguamiento [1/s] - prueba: 0.1, 0.5, 1.0
    f0 = 1.0         # Frecuencia inicial [Hz] - prueba: 0.5, 1.0, 2.0
    beta = 1.5       # Tasa de barrido [Hz/s] - prueba: 1.0, 2.0, 3.0, -1.0
    phi = 0.0        # Fase inicial [rad]
    Ts = 0.05        # Periodo de muestreo [s] - ¡IMPORTANTE! prueba: 0.05, 0.1, 0.2
    tf = 8.0         # Tiempo final [s]
